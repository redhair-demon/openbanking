...
//        )));
//
//        List<Object> accounts = ((Map<String, List<Object>>) template.exchange(
//                "%s?".formatted(contactsEndpoint),
//            HttpMethod.GET,
//            new HttpEntity<>(
//                    null,
//            headers
...
//            logger.info("%s, %s".formatted(codeChallenge, codeVerifier));
